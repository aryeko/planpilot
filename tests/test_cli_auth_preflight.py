...
def test_validate_github_auth_for_init_returns_org_owner_type(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("planpilot.core.auth.preflight.httpx.Client", lambda **_kw: fake)
...
def test_validate_github_auth_for_init_owner_paths_emit_phase_done(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("planpilot.core.auth.preflight.httpx.Client", lambda **_kw: fake_missing_owner)
    ...
    monkeypatch.setattr("planpilot.core.auth.preflight.httpx.Client", lambda **_kw: fake_user_owner)
    ...
    monkeypatch.setattr("planpilot.core.auth.preflight.httpx.Client", lambda **_kw: fake_unknown_owner)
    assert _validate_github_auth_for_init(token="tok", target="owner/repo", progress=progress) is None
