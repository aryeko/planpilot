...
from planpilot_v2.providers.github._retrying_transport import RetryingTransport
...
class TestTransportErrors:
    @pytest.mark.asyncio
    @patch("planpilot_v2.providers.github._retrying_transport.RetryingTransport._sleep_backoff", new_callable=AsyncMock)
...
class TestRateLimit:
    @pytest.mark.asyncio
    @patch(
        "planpilot_v2.providers.github._retrying_transport.RetryingTransport._sleep_backoff",
        new_callable=AsyncMock,
    )
    @patch(
        "planpilot_v2.providers.github._retrying_transport.RetryingTransport._apply_rate_limit_pause",
        new_callable=AsyncMock,
    )
