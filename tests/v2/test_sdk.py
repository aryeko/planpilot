...
from planpilot_v2.contracts.exceptions import ConfigError, PlanLoadError, PlanValidationError, ProviderError, SyncError
...
async def test_from_config_wires_renderer(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("planpilot_v2.sdk.create_renderer", _fake_create_renderer)
...
async def test_from_config_unknown_renderer_raises_config_error(
    ...
    monkeypatch.setattr("planpilot_v2.sdk.create_renderer", _boom)
...
async def test_sync_builds_provider_via_token_resolver_and_factory(
    ...
    monkeypatch.setattr("planpilot_v2.sdk.create_token_resolver", lambda _: _FakeTokenResolver("resolved-token"))
    monkeypatch.setattr("planpilot_v2.sdk.create_provider", _fake_create_provider)
...
async def test_sync_provider_factory_value_error_is_wrapped_as_config_error(
    ...
    monkeypatch.setattr("planpilot_v2.sdk.create_token_resolver", lambda _: _FakeTokenResolver())

    def _boom(*args: object, **kwargs: object) -> SpyProvider:
        raise ValueError("bad provider")

    monkeypatch.setattr("planpilot_v2.sdk.create_provider", _boom)
...
def test_load_config_does_not_wrap_unexpected_url_parser_errors(
    ...
    monkeypatch.setattr("planpilot_v2.sdk.parse_project_url", _boom)
