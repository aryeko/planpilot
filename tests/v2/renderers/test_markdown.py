from planpilot_v2.contracts.plan import Estimate, PlanItem, PlanItemType, Scope, SpecRef, Verification
...
def test_render_renders_all_populated_sections() -> None:
    ...
    item = PlanItem(
        ...
        verification=Verification(
            commands=["pytest tests/v2/renderers -q"],
            ci_checks=["lint"],
    ...
    assert "Commands:\n\n* pytest tests/v2/renderers -q" in body
    assert "CI checks:\n\n* lint" in body
