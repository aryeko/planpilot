...
shell = "rm -rf src/planpilot_v2/providers/github/github_gql && pipx run --spec 'ariadne-codegen>=0.17,<0.18' ariadne-codegen"
```
...
**Output:** Overwrites `src/planpilot_v2/providers/github/schema.graphql`.
...
**Output:** Regenerates `src/planpilot_v2/providers/github/github_gql/` with all typed models and the `GitHubGraphQLClient` class.
...
1. Write a `.graphql` file in `src/planpilot_v2/providers/github/operations/`
