...
class FetchRelations(BaseModel):
    nodes: list[
        Annotated[Union["FetchRelationsNodesNode", "FetchRelationsNodesIssue"], Field(discriminator="typename__")]
        | None
    ]
...
class FetchRelationsNodesIssueBlockedBy(BaseModel):
    nodes: list[Optional["FetchRelationsNodesIssueBlockedByNodes"]] | None
