...
from planpilot_v2.providers.github.github_gql.client import GitHubGraphQLClient
from planpilot_v2.providers.github.github_gql.fragments import IssueCore
...
class GitHubProvider(Provider):
    ...
    async def _get_issue(self, item_id: str) -> IssueCore:  # pragma: no cover
        client = self._require_client()
        from planpilot_v2.providers.github.github_gql.get_issue import GetIssueNodeIssue
