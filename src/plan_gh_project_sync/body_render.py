...
def epic_body(epic: Dict[str, object], plan_id: str, stories_list: Optional[str] = None) -> str:
...
def story_body(story: Dict[str, object], plan_id: str, epic_link: str, tasks_section: Optional[str] = None) -> str:
